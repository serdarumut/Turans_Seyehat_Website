...
<head>
  ...
  <title>Kayıt Ol | Turans Seyahat</title>
...
<body>
  ...
  <div class="register-card">
    ...
    <form action="register_process.php" method="POST">
      ...
      <button type="submit" class="btn btn-custom w-100 mt-2">Kayıt Ol</button>
    </form>
    <p class="mt-3 mb-0">Zaten hesabınız var mı? <a href="login.php">Giriş yap</a></p>
  </div>
